...
// sistema  dlya poiska krujkov i sekciy dlya detey.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CsistemadlyapoiskakrujkovisekciydlyadeteyApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CsistemadlyapoiskakrujkovisekciydlyadeteyApp

CsistemadlyapoiskakrujkovisekciydlyadeteyApp::CsistemadlyapoiskakrujkovisekciydlyadeteyApp()
{
...
// Единственный объект CsistemadlyapoiskakrujkovisekciydlyadeteyApp

CsistemadlyapoiskakrujkovisekciydlyadeteyApp theApp;


// Инициализация CsistemadlyapoiskakrujkovisekciydlyadeteyApp

BOOL CsistemadlyapoiskakrujkovisekciydlyadeteyApp::InitInstance()
{
	...
	CsistemadlyapoiskakrujkovisekciydlyadeteyDlg dlg;
	m_pMainWnd = &dlg;
